                ...
                for j in range (1,4):
                    try:
                        ...
                        if(graph_id in graph_list[num]):
                            ...
                            list.append("%s.png" %(graph_name[0]))
...
def main():
    ...
    ##전월 그래프
    startdate_before = input("(ex 2021-01-01 00:00) 시작 날짜를 입력 하세요: ")
    enddate_before = input("(ex 2021-01-02 00:00) 종료 날짜를 입력 하세요: ")

    ##현월 그래프
    startdate_after = input("(ex 2021-01-01 00:00) 시작 날짜를 입력 하세요: ")
    enddate_after = input("(ex 2021-01-02 00:00) 종료 날짜를 입력 하세요: ")
    ...
    list_before = capture(startdate_before, enddate_before)
    list_after = capture(startdate_after, enddate_after)
